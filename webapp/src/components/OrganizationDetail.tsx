  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 2, mb: 2 }}>
        <Box>
          <Typography sx={{ fontWeight: 800, fontSize: "1.7rem", color: "#111827", mb: 0.5 }}>
            {organization.name}
          </Typography>
          <Typography sx={{ color: "#7b8bb2", fontWeight: 500 }}>
            Owner: <span style={{ color: "#111827", fontWeight: 600 }}>{ownerLabel}</span>
          </Typography>
          <Typography sx={{ color: "#7b8bb2", fontWeight: 500 }}>
            Employees: <span style={{ color: "#111827", fontWeight: 700 }}>{organization.employees}</span>
          </Typography>
        </Box>
